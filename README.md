[![Build Status](https://travis-ci.org/piotrkochan/go-sqlmock.svg)](https://travis-ci.org/piotrkochan/go-sqlmock)
[![GoDoc](https://godoc.org/github.com/piotrkochan/go-sqlmock?status.svg)](https://godoc.org/github.com/piotrkochan/go-sqlmock)
[![Go Report Card](https://goreportcard.com/badge/github.com/piotrkochan/go-sqlmock)](https://goreportcard.com/report/github.com/piotrkochan/go-sqlmock)
[![codecov.io](https://codecov.io/github/piotrkochan/go-sqlmock/branch/master/graph/badge.svg)](https://codecov.io/github/piotrkochan/go-sqlmock)
...
## Install
    ...
    go get github.com/piotrkochan/go-sqlmock

## Documentation and Examples

Visit [godoc](http://godoc.org/github.com/piotrkochan/go-sqlmock) for general examples and public api reference.
See **.travis.yml** for supported **go** versions.
Different use case, is to functionally test with a real database - [go-txdb](https://github.com/piotrkochan/go-txdb)
all database related actions are isolated within a single transaction so the database can remain in the same state.

See implementation examples:

- [blog API server](https://github.com/piotrkochan/go-sqlmock/tree/master/examples/blog)
- [the same orders example](https://github.com/piotrkochan/go-sqlmock/tree/master/examples/orders)
...
import (
	...
	"github.com/piotrkochan/go-sqlmock"
)
...
**sqlmock** provides an [Argument](https://godoc.org/github.com/piotrkochan/go-sqlmock#Argument) interface which
...
- **2016-02-23** - convert expected arguments to driver.Value as natural
  ...
  stricter. See [issue](https://github.com/piotrkochan/go-sqlmock/issues/31).
...
interface methods, see [issue](https://github.com/piotrkochan/go-sqlmock/issues/5)
- **2014-05-29** allow to match arguments in more sophisticated ways, by providing an **sqlmock.Argument** interface
- **2014-04-21** introduce **sqlmock.New()** to open a mock database connection for tests. This method
calls sql.DB.Ping to ensure that connection is open, see [issue](https://github.com/piotrkochan/go-sqlmock/issues/4).
...
See [issue 1](https://github.com/piotrkochan/go-sqlmock/issues/1)
